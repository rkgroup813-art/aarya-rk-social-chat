...
export default function BottomNav({ currentScreen, onNavigate, isAdmin }: Props) {
  const navItems = [
    { id: "chat" as Screen, icon: ChatIcon, label: "Chat" },
    { id: "feed" as Screen, icon: FeedIcon, label: "Feed" },
    { id: "profile" as Screen, icon: ProfileIcon, label: "Profile" },
    { id: "settings" as Screen, icon: SettingsIcon, label: "Settings" },
  ];

  if (isAdmin) {
    navItems.push({ id: "admin" as Screen, icon: AdminIcon, label: "Admin" });
  }
